import { initialiseInsightsPage } from "./insights/index.js?v=20260412-insights-shell01";
...
const syncToggleState = (toggle, content, isExpanded, shouldResize = false) => {
    const icon = toggle.querySelector(".insight-flow-toggle-icon");
    const label = toggle.querySelector(".insight-flow-toggle-label");
...
const initialiseCollapsibleSections = () => {
    const toggles = document.querySelectorAll(".insight-flow-toggle");
